      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        <div className="z-10 order-2 md:order-1">
          ...
          <h1 className="text-5xl lg:text-7xl font-black leading-[1.05] mb-8 tracking-tighter uppercase">
            ¿Tu imagen está <span className="text-primary italic">cerrando negocios</span> por ti o te está haciendo perder dinero?
          </h1>
          <p className="text-muted-blue text-xl mb-10 max-w-xl leading-relaxed font-bold">
            Domina el Método de Autoridad Visual para Ejecutivos y proyecta el poder necesario para escalar tu carrera o negocio en solo 15 días.
          </p>
